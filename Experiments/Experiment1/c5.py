# Integrantes:
#Cajas Jefferson - Granda Jhon - Ruales Marlon - Sanchéz Andrés - Velasco Jhonny 
...
# Creación Hashtable con tamaño de cubetas quemado
create_HashTable(elements1, 7)
create_HashTable(elements2, 11)
# Creación Hashtable con tamaño de cubetas calculado con factor de carga 0.75
